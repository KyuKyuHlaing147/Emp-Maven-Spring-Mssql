              ...
              <li class="nav-item active submenu">
                ...
                <div class="collapse show" id="tables">
                  <ul class="nav nav-collapse">
                    ...
                    <li class="active">
                      <a href="${pageContext.request.contextPath}/viewemp">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Employee Edit Form</div>
                  </div>
                  <form:form method="POST" action="/EmpSpringMvc/editsave" modelAttribute="emp">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <input type="hidden" name="id" value="${emp.id}"/> <!-- Add this hidden field -->
                <div class="form-group">
                    <label for="name">Name</label>
                    <input type="text" name="name" class="form-control" id="name" value="${emp.name}" placeholder="Enter name"/>
                </div>
                <div class="form-group">
                    <label for="salary">Salary</label>
                    <input type="number" step="0.01" name="salary" class="form-control" id="salary" value="${emp.salary}" placeholder="Salary"/>
                </div>
                <div class="form-group">
                    <label for="designation">Position</label>
                    <input type="text" name="designation" class="form-control" id="designation" value="${emp.designation}" placeholder="Choose Position"/>                      
                </div>                     
                <div class="card-action">
                    <button type="submit" class="btn btn-success">Update</button>
                    <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/viewemp" style="color:white;">Cancel</a></button>
                </div>
            </div>
        </div>
    </div>
